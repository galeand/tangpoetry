...
import com.sse.tangpoetry.mapper.TestXMappper;
...
//        });
        ...
        Poet poet = poetMapper.getPoetByName("李世民");
        System.out.println(poet);
    }

    @Test
    public void test02() {
//        String title_name = "静夜思";
////        List<Poetry> poetrys = poetryMapper.getPoetryLiketitle(title_name);
////        System.out.println(poetrys.toString());
//
//        List<Object> list = poetryService.getPoetryByTitle(title_name);
//        System.out.println(list.toString());

        TestX x1 = testXMappper.getPoetByName("李白");
